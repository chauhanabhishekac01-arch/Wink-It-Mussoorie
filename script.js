...
/*Water*/                { id: 24,  name: "Mineral Water",                                                  image: "dwater.jpg",            cat: "beverages",                subcat: "Water & Soda",                selectedVariant: "S",          variants: { "S":        { price: 20, count: 0, unit: "1L" }, "L": { price: 75, count: 0, unit: "5L" } } },
                         ...
                         { id: 26,  name: "Bisleri Soda",                                                   image: "dbsoda.jpg",            cat: "beverages",                subcat: "Water & Soda",                selectedVariant: "S",          variants: { "S":        { price: 20, count: 0, unit: "750ml" } } },
...
/*Kurkure*/             { id: 4001, name: "Kurkure Chutney",                                                image: "skurkurec.jpg",         cat: "snacks",                   subcat: "Kurkure",                    selectedVariant: "L",           variants: { "L":        { price: 20, count: 0, unit: "75g" } } },
                        ...
                        { id: 4003, name: "Kurkure Masala",                                                 image: "skurkurem.jpg",         cat: "snacks",                   subcat: "Kurkure",                    selectedVariant: "L",           variants: { "L":        { price: 20, count: 0, unit: "75g" } } },
                        { id: 4004, name: "Kurkure Puffcorn",                                               image: "skurkurep.jpg",         cat: "snacks",                   subcat: "Kurkure",                    selectedVariant: "L",           variants: { "L":        { price: 20, count: 0, unit: "75g" } } },
                        { id: 4005, name: "Kurkure Schezwan Chutney",                                       image: "skurkuresc.jpg",        cat: "snacks",                   subcat: "Kurkure",                    selectedVariant: "L",           variants: { "L":        { price: 20, count: 0, unit: "75g" } } },

/*Lays*/                { id: 4006, name: "Lay's India's Masala",                                                image: "slaysb.jpg",            cat: "snacks",                   subcat: "Lays",                       selectedVariant: "L",           variants: { "L":        { price: 20, count: 0, unit: "200g" } } },
...
/*Body*/                { id: 5004, name: "Pears Pack of 3",                                                image: "pcpears.jpg",           cat: "bnb",                      subcat: "Soap",                       selectedVariant: "Piece",       variants: { "Piece":    { price: 200, count: 0, unit: "1pk" } } },
                        { id: 5005, name: "NIVEA Shower Gel Waterlily",                                   image: "pcbodywash.jpg",        cat: "bnb",                      subcat: "Body Wash",                  selectedVariant: "Piece",       variants: { "Piece":    { price: 135, count: 0, unit: "125ml" } } },
...
/*Milk*/                 { id: 8135, name: "Amul Gold",                                        image: "rmulkag.jpg",           cat: "dbm",                      subcat: "Milk",                      selectedVariant: "Qty",          variants: { "Qty":     { price: 83, count: 0, unit: "1L" } } },
                        ...
                        { id: 8040, name: "Amul Butter",                                                   image: "rbutter.jpg",           cat: "dbm",                      subcat: "Butter",                     selectedVariant: "Qty",          variants: { "Qty":     { price: 60, count: 0, unit: "100g" } } },
...
/*Noodles*/                { id: 9001, name: "Maggie",                                                      image: "ifmaggie.jpg",           cat: "instant",                  subcat: "Noodles",                   selectedVariant: "Qty",          variants: { "Qty":     { price: 10, count: 0, unit: "70g" } } },
                           ...
                           { id: 9111, name: "Nissin Mazedar Masala Cup Noodles",                           image: "inn.jpg",               cat: "instant",                  subcat: "Noodles",                   selectedVariant: "Qty",          variants: { "Qty":     { price: 55, count: 0, unit: "70g" } } },
                           { id: 9112, name: "Nissin Vegetable Manchow Cup Noodles",                        image: "innm.jpg",              cat: "instant",                  subcat: "Noodles",                   selectedVariant: "Qty",          variants: { "Qty":     { price: 55, count: 0, unit: "70g" } } },
...
/*bakery*/                { id: 1001,   name: "Atta Biscuit",                                               image: "omiattab.jpg",          cat: "partneromi",               subcat: "Bakery",                    selectedVariant: "Qty",          variants: { "Qty":     { price: 40, count: 0, unit: "1pkt" } } },
        ...
        /*Namkeen*/       { id: 1020,   name: "Besan Sew",                                                  image: "omibsew.jpg",           cat: "partneromi",               subcat: "Namkeen",                   selectedVariant: "Qty",          variants: { "Qty":     { price: 60, count: 0, unit: "200g" } } },
            ...
            /*Desserts*/  { id: 1070,   name: "Black Forest Cake",                                          image: "omibfc.jpg",            cat: "partneromi",               subcat: "Cakes",                    selectedVariant: "Qty",          variants: { "Qty":     { price: 300, count: 0, unit: "1 Pound" } } },
              ...
              /*Snacks*/  { id: 1034,   name: "Pakodi",                                                     image: "omipak.jpg",            cat: "partneromi",               subcat: "Snacks",                    selectedVariant: "Qty",          variants: { "Qty":     { price: 70, count: 0, unit: "100gm" } } },        
              ...
              /*Desserts*/  { id: 1124,   name: "Pastry Truffle",                                           image: "omitp.jpg",             cat: "partneromif",              subcat: "Sweets",                    selectedVariant: "Qty",          variants: { "Qty":      { price: 50, count: 0, unit: "1pc" } } },
                            ...
                            { id: 1319,   name: "Peas",                                      image: "vfpeas.jpg",            cat: "fresh",                     subcat: "Veggies",   selectedVariant: "Qty",           variants: { "Qty":      { price: 80, count: 0, unit: "1b" } } },             
